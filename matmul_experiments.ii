# 0 "matmul_experiments.cpp"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "matmul_experiments.cpp"
...
# 39 "/usr/include/c++/11/type_traits" 2 3
...
# 42 "/usr/include/c++/11/chrono" 2 3
...
# 41 "/usr/include/c++/11/bits/parse_numbers.h" 2 3
...
# 3172 "/usr/include/c++/11/chrono" 3
  }
  ...
  {
# 3203 "/usr/include/c++/11/chrono" 3
...
# 3298 "/usr/include/c++/11/chrono" 3
#pragma GCC diagnostic pop
...
# 3357 "/usr/include/c++/11/chrono" 3
...
# 3386 "/usr/include/c++/11/chrono" 3
    private:
...
# 4 "matmul_experiments.cpp" 2


# 5 "matmul_experiments.cpp"
using namespace std;
int main() {
  int M = 2000;
  int N = 2000;
  ...
  int size_C =
      M * N * sizeof(float);
# 31 "matmul_experiments.cpp"
  float *A = new float[M * K];
  float *B = new float[K * N];
  float *C = new float[M * N];
# 126 "matmul_experiments.cpp"
  for (int i = 0; i < M * K; ++i) {
    A[i] = 1.0f;
  }
  for (int i = 0; i < K * N; ++i) {
...
# 237 "matmul_experiments.cpp"
  double avg_time = 0.0L;
  int num_runs = 10;
  int warmup_runs = 3;
# 272 "matmul_experiments.cpp"
