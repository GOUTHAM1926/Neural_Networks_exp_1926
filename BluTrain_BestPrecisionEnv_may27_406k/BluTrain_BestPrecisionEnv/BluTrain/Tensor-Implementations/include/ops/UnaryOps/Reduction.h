...
#endif // ✨✨✨
// CRITICAL STEP: Include the implementation header which contains ALL template
// definitions. This allows the non-template functions in reductions.cpp to
...
// 1. Core Reductions
// =================================================================
Tensor reduce_sum(const Tensor &input, const std::vector<int64_t> &axes = {},
                  bool keepdim = false, cudaStream_t stream = 0); // ✨✨✨
Tensor reduce_product(const Tensor &input,
                      const std::vector<int64_t> &axes = {},
                      bool keepdim = false, cudaStream_t stream = 0); // ✨✨✨
Tensor reduce_min(const Tensor &input, const std::vector<int64_t> &axes = {},
                  bool keepdim = false, cudaStream_t stream = 0); // ✨✨✨
Tensor reduce_max(const Tensor &input, const std::vector<int64_t> &axes = {},
                  bool keepdim = false, cudaStream_t stream = 0); // ✨✨✨
Tensor reduce_mean(const Tensor &input, const std::vector<int64_t> &axes = {},
                   bool keepdim = false, cudaStream_t stream = 0); // ✨✨✨

// =================================================================
// 2. NaN-Aware Reductions
// =================================================================
Tensor reduce_nansum(const Tensor &input, const std::vector<int64_t> &axes = {},
                     bool keepdim = false, cudaStream_t stream = 0); // ✨✨✨
Tensor reduce_nanproduct(const Tensor &input,
                         const std::vector<int64_t> &axes = {},
                         bool keepdim = false,
                         cudaStream_t stream = 0); // ✨✨✨
Tensor reduce_nanmin(const Tensor &input, const std::vector<int64_t> &axes = {},
                     bool keepdim = false, cudaStream_t stream = 0); // ✨✨✨
Tensor reduce_nanmax(const Tensor &input, const std::vector<int64_t> &axes = {},
                     bool keepdim = false, cudaStream_t stream = 0); // ✨✨✨
Tensor reduce_nanmean(const Tensor &input,
                      const std::vector<int64_t> &axes = {},
                      bool keepdim = false, cudaStream_t stream = 0); // ✨✨✨
...
Tensor reduce_argmin(const Tensor &input, const std::vector<int64_t> &axes = {},
                     bool keepdim = false, cudaStream_t stream = 0); // ✨✨✨
Tensor reduce_argmax(const Tensor &input, const std::vector<int64_t> &axes = {},
                     bool keepdim = false, cudaStream_t stream = 0); // ✨✨✨

// =================================================================
// 4. NaN-Aware Index Reductions
// =================================================================
Tensor reduce_nanargmin(const Tensor &input,
                        const std::vector<int64_t> &axes = {},
                        bool keepdim = false,
                        cudaStream_t stream = 0); // ✨✨✨
Tensor reduce_nanargmax(const Tensor &input,
                        const std::vector<int64_t> &axes = {},
                        bool keepdim = false,
                        cudaStream_t stream = 0); // ✨✨✨
 ...
 * @param correction Bessel's correction (default=1 for sample variance, 0 for
 * population) Formula: var = sum((x - mean)Â²) / (N - correction)
 */
Tensor reduce_var(const Tensor &input, const std::vector<int64_t> &axes = {},
                  bool keepdim = false, int64_t correction = 1,
                  cudaStream_t stream = 0); // ✨✨✨
 ...
 * @param correction Bessel's correction (default=1 for sample std, 0 for
 * population) Formula: std = sqrt(var)
 */
...
Tensor reduce_nanmedian(const Tensor &input,
                        const std::vector<int64_t> &axes = {},
                        bool keepdim = false,
                        cudaStream_t stream = 0); // ✨✨✨
